...
import { createPost, getAllComments, getAllPosts,postComment } from "@/config/redux/action/postAction";
...
import { increamentLike } from "@/config/redux/action/postAction";
     ...
     <DashboardLayout>
      <div className={styles.scrollComponent}>
        ...
        <div className={styles.createPostContainer}>
          ...
          <textarea onChange={ (e) => setPostContent(e.target.value)} value={postContent} placeholder={"What's in your mind"}name="" className={styles.textAreaOfContent}></textarea>
                ...
                <div className={styles.singleCard__profileContainer}>
                  ...
                  <div>
                    ...
                    <div className={styles.optionsContainer}>
                     ...
                     <div  onClick={ async () => {
                        await dispatch( increamentLike({ post_id: post._id}));
                        await dispatch(getAllPosts());
                     }}   
      ...
      </div>
      {
        ...
        className={styles.commentsContainer}>
              ...
              className={styles.allCommentsContainer}>
                ...
                {postState.comments.length === 0 && <h4>No Comments</h4>}
                 ...
                 <div>
                      {postState.comments.map( (postComment, index) => {
                          ...
                          <div className={styles.singleComment} key={postComment._id} style={{ marginBottom: "1rem"}}>

                                <div className={styles.singleComment_profileContainer}>

                                    <img className={styles.commentUserProfile} src={`${BASE_URL}/${postComment.userId.profilePicture}`} alt="" />
                                    <div>
                                         <p style={{ fontWeight:"bold", fontSize:"1rem" }}>{postComment.userId.name}</p>
                                         <p style={{ color: "grey"}}>@{postComment.userId.username}</p>
                                    </div>
